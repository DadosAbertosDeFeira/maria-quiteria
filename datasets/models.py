...
class Paycheck(DatasetMixin):
    ...
    # FIXME check null fields and uniqueness
    ...
    @classmethod
    def last_collected_item_date(cls):
        """Retorna primeiro dia do mês e ano do pagamento."""

        try:
            last_payment = cls.objects.last()
            if last_payment:
                return date(last_payment.year, last_payment.month, 1)
            return
        except cls.DoesNotExist:
            return
